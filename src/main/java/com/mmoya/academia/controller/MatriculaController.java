...
public class MatriculaController implements IController<Matricula>{
	...
	@PostMapping
	@Override
	public Mono<ResponseEntity<Matricula>> registrar(@RequestBody Matricula t, ServerHttpRequest request) {
	...
	@Override
	@PutMapping
	public Mono<ResponseEntity<Matricula>> modificar(@RequestBody Matricula t) {
